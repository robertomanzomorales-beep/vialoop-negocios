...
const products: Product[] = [
  { id: "demo-1", name: "Cerveza Cristal lata 473cc", category: "Cervezas", price: 1290, cost: 840, stock: 8, minStock: 12, barcode: "7802100001181", accent: "#f4b721" },
  { id: "demo-2", name: "Coca-Cola 1,5 L", category: "Bebidas", price: 2190, cost: 1510, stock: 22, minStock: 10, barcode: "7801610001162", accent: "#ef4444" },
  { id: "demo-3", name: "Pisco Mistral 35° 750cc", category: "Licores", price: 8990, cost: 6820, stock: 5, minStock: 6, barcode: "7802110000754", accent: "#7c3aed" },
  { id: "demo-4", name: "Pan hallulla", category: "Panadería", price: 1800, cost: 1120, stock: 34, minStock: 20, barcode: "2000000001015", accent: "#d97706" },
  { id: "demo-5", name: "Leche entera Soprole 1 L", category: "Lácteos", price: 1350, cost: 920, stock: 16, minStock: 8, barcode: "7802900005020", accent: "#2563eb" },
  { id: "demo-6", name: "Papas fritas Marco Polo 180g", category: "Snacks", price: 2490, cost: 1670, stock: 11, minStock: 8, barcode: "7802200003665", accent: "#16a34a" },
];
...
export default function DashboardClient({ businessName, userName }: { businessName: string; userName: string }) {
    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          ...
          <button className="profile" onClick={async () => { await fetch("/api/auth/signout", { method: "POST" }); window.location.href = "/login"; }} title="Cerrar sesión">
            <span className="avatar">{userName.split(" ").map((part) => part[0]).join("").slice(0, 2).toUpperCase()}</span>
            <span><strong>{userName}</strong><small>Administrador</small></span><b>Salir</b>
          </button>
        </div>
      </aside>
      ...
      <section className="workspace">
        <header className="topbar">
          <div><p className="eyebrow">{businessName.toUpperCase()}</p><h1>{active === "Resumen" ? `Buenos días, ${userName.split(" ")[0]}` : active}</h1></div>
